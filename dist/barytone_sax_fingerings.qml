...
MuseScore {
   version: "3.5"
   description: qsTr("This plugin adds barytone saxophone fingerings to your selection or the whole score if nothing is selected")
   requiresScore: true
   menuPath: "Plugins." + qsTr("saxophone fingerings") + "." + qsTr("barytone")
   categoryCode: "composing-arranging-tools"
   thumbnailName: "thumbnail_barytone.png"
   ...
   function pitchToText(pitch) {
      ...
      pitch = pitch + 21; // transpose to barytone saxophone
      switch(pitch){
