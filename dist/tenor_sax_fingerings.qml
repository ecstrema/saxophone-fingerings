...
MuseScore {
   version: "3.5"
   description: qsTr("This plugin adds tenor saxophone fingerings to your selection or the whole score if nothing is selected")
   requiresScore: true
   menuPath: "Plugins." + qsTr("saxophone fingerings") + "." + qsTr("tenor")
   categoryCode: "composing-arranging-tools"
   thumbnailName: "thumbnail_tenor.png"
